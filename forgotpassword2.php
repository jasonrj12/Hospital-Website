<html>
    ...
    <body>
      <form name="registration" method="post" action="forgot2.php"  onsubmit="return formValidation()">
    <section id="nav-bar">
              ...
              <h3><i class="fa fa-sign-in"></i>Reset-Password</h3>
                <form>
                    <div  class="name">	
                        ...
                        <input type="text" placeholder="Enter Username" name="dname" id="name">
                        <label >Enter your email</label>
                        <input type="email" placeholder="Enter your email" name="demail" id="password" style="width:25rem;padding: 15px 20px;margin: 8px 0;display: flex;border: 1px solid #ccc;box-sizing:border-box;box-shadow: 5px 10px 5px #ccc;
    border-radius: 5px;
    color: #e93187;
    margin-bottom: 30px;">
