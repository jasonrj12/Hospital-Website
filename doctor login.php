<html>
    ...
    <body>
      <form name="registration" method="post" action="doctor log-in.php" onsubmit="return formValidation()" >
    <section id="nav-bar">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="Sigin.php">Sign-up</a>
                  </li>
                  <li class="nav-item">
            ...
            <div class="col-md-8" style="align-content: center;padding-left: 22rem;">
              <h3><i class="fa fa-sign-in"></i>Doctor Log-in</h3>
                    <div  class="name">	
                        ...
                        <div class="forgot" >
                      <a href="forgotpassword2.php" class="btn">Forgot password?</a>
                        </div>
                      </div>
               </div>  
            </div>    
