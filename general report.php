<html>
    ...
    <body>
      <form name="registration" method="post" action="general.php"  onsubmit="return formValidation()">
    <section id="nav-bar">
    ...
    <section id="sign-in">
        ...
        <div class="row">
            <div class="col-md-8" style="align-content: center;padding-left: 22rem;">
              <h3><i class="fa fa-sign-in"></i>View-Report</h3>
                <form>
                    <div  class="name">	
                        <label >Username</label>
                        <input type="text" placeholder="Enter Username"name="pname" id="name">
                        <label >Password</label>
                        <input type="date" placeholder="Enter date of birth" name="pdob" id="password" style="width:25rem;padding: 15px 20px;margin: 8px 0;display: flex;border: 1px solid #ccc;box-sizing:border-box;box-shadow: 5px 10px 5px #ccc;
    border-radius: 5px;
    color: #e93187;
    margin-bottom: 30px;">
                        <button type="submit" name="login">View-Report</button>
                        </div>
                </form>
            </div>
