<html>
    ...
    <section id="sign-in">
        ...
        <div class="row">
           <div class="col-md-6" >
            <h3><i class="fa fa-sign-in"></i>Doctor Sign-up</h3>
              <img src="dc1.jpg" class="fluid">
              <div class="col">
              <a href="doctor Sign-in1.php" class="btn">Sign-up</a>
              </div>
            </div>
            <div class="col-md-6">
              <h3><i class="fa fa-sign-in"></i>Patient Sign-up</h3>
              <img src="p1.jpg" class="fluid" style="padding-left:6rem; width:25rem;">
              <div class="col">
                <a href="patient sign-in.php" class="btn">Sign-up</a>
                </div>
            </div>
           </div>
           </div>
    ...
    <section id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <hr>
          <p class="copyright"><i class="fa fa-copyright"></i>2024 Care Compass Hospitals.</p>
      </div>
    </section>
  <!------smooth scroll-->  
