...
<body>
 ...
 <?php
     if(isset($_GET['repid']))
  {
   $query = mysqli_query($con, "SELECT * FROM `appointment`  WHERE aid = '$_GET[repid]'") or die(mysqli_error($con));
...
<div class="info-card">
    ...
    <h4 style="text-align: center;font-size:30px;">Patient Details</h4>
            <div class="card-detail" style="display:inline-block;  justify-content: space-between;margin-left:10rem;">
                ...
                <h2 style="font-size:17px;">Patient-id:  <?php echo "".$fetch['aid']."";?></h2>
                <h2 style="font-size:17px;">Patient-name:  <?php echo "".$fetch['aname']."";?></h2>
                 <h2 style="font-size:17px;">Patient-dob:  <?php echo "".$fetch['adob']."";?></h2>
                <h2 style="font-size:17px;">Patient-Number:  <?php echo "".$fetch['anumber']."";?></h2>
                 <h2 style="font-size:17px;">Patient-Email:  <?php echo "".$fetch['aemail']."";?></h2>
                <h2 style="font-size:17px;">Patient-Systoms:  <?php echo "".$fetch['asymtoms']."";?></h2>
            </div>
        </div>
        <label >Treatment</label>
<textarea rows="4"  name=treatment id="appreason" ></textarea>
 <input type="hidden" placeholder="pid" name="pid" id="pid" value="<?php echo "".$fetch['aid']."";?>"> 
